...
@WebServlet("/request5")
public class admin_donation extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            for (String name : request.getParameterMap().keySet()) {
                ...
                String updateQuery = "UPDATE donate SET status = ? WHERE name = ?";
        ...
        response.sendRedirect(request.getContextPath() + "/admin-donation.jsp");
    }
}